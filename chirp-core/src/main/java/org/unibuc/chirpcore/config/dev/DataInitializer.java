package org.unibuc.chirpcore.config.dev;
...
public class DataInitializer {
    ...
    CommandLineRunner initialize(
        ...
        return args -> {
            createUserIfNotFound("test_user_1", authService);
            createUserIfNotFound("test_user_2", authService);
    ...
    private void createUserIfNotFound(String username, AuthService authService) {
